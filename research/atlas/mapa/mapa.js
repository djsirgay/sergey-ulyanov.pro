(() => {
  ...
  const text = {
    en: {
      ...
      scope:'7 mapped years · 28 chronology stages · EN / БЕЛ', scopeNote:'An independent edition inspired by MAPA, with new code and source-linked notes.',
    ...
    be: {
      ...
      scope:'7 гадоў на мапе · 28 этапаў храналогіі · EN / БЕЛ',scopeNote:'Незалежная версія, натхнёная MAPA: новы код і анатацыі са спасылкамі на крыніцы.',
