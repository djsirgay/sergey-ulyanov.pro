(() => {
  const copy = {
    en: {
      ...
      'credits-title':'Original project credits','person-cherenkevich':'Alexey Cherenkevich (Аляксей Чаранкевіч)','person-shpileuski':'Yauhen Shpileuski (Яўген Шпілеўскі)','person-shyrayeva':'Hanna Shyrayeva (Ганна Шыраева)','person-yakunin':'Viktar Yakunin (Віктар Якунін)','person-kedzich':'Pavel Kedzich (Павел Кедзіч)','credit-idea':'idea and design','credit-texts':'texts and translations','credit-management':'management','credit-advice':'advice','source-process':'Original process article','source-results':'Original results article','source-archive':'Public archived capture','source-author':'Creator’s current portfolio',
    ...
    be: {
      ...
      'credits-title':'Крэдыты арыгінальнага праекта','person-cherenkevich':'Аляксей Чаранкевіч','person-shpileuski':'Яўген Шпілеўскі','person-shyrayeva':'Ганна Шыраева','person-yakunin':'Віктар Якунін','person-kedzich':'Павел Кедзіч','credit-idea':'ідэя і дызайн','credit-texts':'тэксты і пераклады','credit-management':'менеджмент','credit-advice':'кансультацыі','source-process':'Артыкул пра працэс','source-results':'Артыкул пра вынікі','source-archive':'Публічная архіўная копія','source-author':'Актуальны партфоліа аўтара',
  ...
  Object.assign(copy.en, {
    ...
    'module-one-title':'MAPA · Belarusian lands through time','module-one-text':'Which states governed the lands of present-day Belarus? Follow the chronology, compare territorial divisions, and inspect the historical sources. The modern outline is an orientation reference, not an ancient border.',
    ...
    'mapa-title':'The same lands. Different states.','mapa-deck':'Explore which states governed the lands of present-day Belarus, including periods of division. Keep the modern outline as a reference, or switch to the wider region. Inspired by Alexey Cherenkevich and the original MAPA team.',
    'status-attributed':'Independent reconstruction','status-pending':'Open to explore','mapa-recovered':'Use it now','mapa-recovered-value':'Choose a historical date, read the territorial affiliation, and compare places. Use the regional view for surrounding states and the source notes for limits and disputed detail.',
    'mapa-scope':'Current coverage','mapa-scope-value':'A sourced chronology with territorial views and place checks, plus ten historical events. Dates with mapped geometry are distinguished from context-only transitions.',
    'mapa-public':'About this edition','mapa-public-value':'A new implementation with independently sourced history and openly licensed geometry. It does not restore all 63 original maps. Unresolved boundaries and differences between sovereignty, occupation and claims remain visible.',
  ...
  Object.assign(copy.be, {
    ...
    'module-one-title':'MAPA · Беларускія землі ў часе','module-one-text':'Якія дзяржавы кіравалі землямі сучаснай Беларусі? Вывучайце храналогію, параўноўвайце тэрытарыяльныя падзелы і правярайце гістарычныя крыніцы. Сучасны контур — арыенцір, а не старажытная мяжа.',
    ...
    'mapa-title':'Тыя самыя землі. Розныя дзяржавы.','mapa-deck':'Вывучайце, якія дзяржавы кіравалі землямі сучаснай Беларусі, у тым ліку ў перыяды падзелу. Пакіньце сучасны контур як арыенцір або пераключыцеся на ўвесь рэгіён. Натхнёна праектам Аляксея Чаранкевіча і каманды MAPA.',
    'status-attributed':'Незалежная рэканструкцыя','status-pending':'Адкрыта для вывучэння','mapa-recovered':'Як карыстацца','mapa-recovered-value':'Абярыце гістарычную дату, прачытайце пра тэрытарыяльную прыналежнасць і параўнайце месцы. Рэгіянальны выгляд паказвае навакольныя дзяржавы; заўвагі да крыніц — абмежаванні і спрэчныя дэталі.',
    'mapa-scope':'Цяперашні абсяг','mapa-scope-value':'Храналогія з крыніцамі, тэрытарыяльнымі выглядамі і праверкай месцаў, а таксама дзесяць гістарычных падзей. Даты з геаметрыяй мапы адрозніваюцца ад пераходаў, для якіх ёсць толькі кантэкст.',
    'mapa-public':'Пра гэтую версію','mapa-public-value':'Новая рэалізацыя з незалежнымі гістарычнымі крыніцамі і адкрытай геаметрыяй. Гэта не аднаўленне ўсіх 63 арыгінальных мапаў. Нявырашаныя межы і розніца паміж суверэнітэтам, акупацыяй і прэтэнзіямі пазначаныя.',
  ...
  Object.assign(records.find(record=>record.id==='mapa'), {
    name:'MAPA · Belarusian lands through time',nameBe:'MAPA · Беларускія землі ў часе',status:'independent',url:'/research/atlas/mapa/',languages:['be','en'],
    description:'Which states governed these lands? Explore historical affiliation, territorial divisions, city checks and the wider region. Mapped evidence is distinguished from context-only transitions; credits and sources stay visible.',
    descriptionBe:'Якія дзяржавы кіравалі гэтымі землямі? Вывучайце гістарычную прыналежнасць, тэрытарыяльныя падзелы, гарады і навакольны рэгіён. Мапы з данымі адрозніваюцца ад пераходаў толькі з кантэкстам; аўтары і крыніцы пазначаныя.'
  });
