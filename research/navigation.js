...
export const routes = Object.freeze({
  ...
  music: {path: '/research/tools/unmute-the-archive/atlas/', en: 'Archive workspace', be: 'Архіўныя запісы', group: 'tools', guide: 'music'},
...
export const guchnaEntry='https://unmute.sergey-ulyanov.pro/login/';
